...
public abstract class BiomeGenBaseMyst
{

    protected BiomeGenBaseMyst(int i)
    {
    ...
    private BiomeGenBaseMyst func_35478_a(float f, float f1)
    {
        field_35490_s = f;
        field_35489_t = f1;
        return this;
    ...
    private BiomeGenBaseMyst func_35479_b(float f, float f1)
    {
        field_35492_q = f;
        field_35491_r = f1;
        return this;
    ...
    private BiomeGenBaseMyst setDisableRain()
    {
        enableRain = false;
        return this;
    }
    ...
    protected BiomeGenBaseMyst setBiomeName(String s)
    {
        biomeName = s;
        return this;
    }

    protected BiomeGenBaseMyst func_4124_a(int i)
    {
        field_6502_q = i;
        return this;
    }

    protected BiomeGenBaseMyst setColor(int i)
    {
        color = i;
        return this;
    }
    ...
    public static final BiomeGenBaseMyst field_35486_a[] = new BiomeGenBaseMyst[256];
    ...
    public static final BiomeGenBase moon = (new BiomeGenMoon(8)).setColor(0xC1C1C1).setBiomeName("Moon").setDisableRain();
