...
public class BlockMoonFire extends Block
{

    protected BlockMoonFire(int i, int j)
    {
    ...
    {
        if(world.getBlockId(i, j - 1, k) == Block.cobblestone.blockID && BlockMoonPortal.tryToCreatePortal(world, i, j, k))
        {
            return;
        }
        if(!world.isBlockNormalCube(i, j - 1, k) && !func_263_h(world, i, j, k))
