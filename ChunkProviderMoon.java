...
label1:
                        ...
                        for(int i2 = 0; i2 < 4; i2++)
                        {
                            ...
                            for(int j2 = 0; j2 < 8; j2++)
                            {
                                ...
                                for(int i3 = 0; i3 < 8; i3++)
                                {
									...
									if(l1 > 0 && l1 <= 6)
                                    {
                                        j3 = mod_moon.mystStone.blockID;
                                    }
									if(l1 > 6 && l1 <= 7)
                                    {
                                        j3 = mod_moon.mystGrass.blockID;
                                    }									
                                    if(d15 > 0.0D)
                                    {
                                        j3 = mod_moon.mystGrass.blockID;
        ...
        for(int k = 0; k < 16; k++)
        {
            for(int l = 0; l < 16; l++)
            {
                ...
                for(int k1 = 127; k1 >= 0; k1--)
                {
                    ...
                    if(byte2 != mod_moon.mystStone.blockID)
                    {
                        continue;
                    }
                    if(j1 == -1)
                    {				
                        ...
                        {
                            byte0 = 0;
                            byte1 = (byte)mod_moon.mystDirt.blockID;
                        }
                        j1 = i1;
                        if(k1 >= 0)
                        {
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        // {
            ...
            // (new WorldGenClay(8)).generate(worldObj, random, k5, l8, j13);
        // }
        ...
        for(int j2 = 0; j2 < 20; j2++)
        {
            ...
            (new WorldGenMinable(mod_moon.mystDirt.blockID, 32)).generate(worldObj, random, l5, i9, k13);
        }
        ...
        for(int k2 = 0; k2 < 10; k2++)
        {
            ...
            (new WorldGenMinable(Block.gravel.blockID, 16)).generate(worldObj, random, i6, j9, l13);
        }
        ...
        for(int i4 = 0; i4 < 1; i4++)
        {
            ...
            (new WorldGenMinable(Block.oreDiamond.blockID, 8)).generate(worldObj, random, j7, k10, i15);
        }
