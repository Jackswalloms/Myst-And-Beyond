...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    public void setInMoonPortal()
    {
        if(timeUntilMoonPortal > 0)
        {
            timeUntilMoonPortal = 10;
            return;
        } else
        {
            inMoonPortal = true;
    ...
    protected boolean inMoonPortal;
    public int timeUntilMoonPortal;
    public float timeInPortal;
    public float prevTimeInPortal;
    public float timeInMoonPortal;
    public float prevTimeInMoonPortal;
