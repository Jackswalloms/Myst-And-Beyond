    ...
    implements IChunkProvider
{
    ...
    public ChunkProviderMoon(World world, long l)
    {
        ...
        worldObj = world;
        moonRNG = new Random(l);
        field_4169_i = new NoiseGeneratorOctaves(moonRNG, 16);
        field_4168_j = new NoiseGeneratorOctaves(moonRNG, 16);
        field_4167_k = new NoiseGeneratorOctaves(moonRNG, 8);
        field_4166_l = new NoiseGeneratorOctaves(moonRNG, 4);
        field_4165_m = new NoiseGeneratorOctaves(moonRNG, 4);
        field_4177_a = new NoiseGeneratorOctaves(moonRNG, 10);
        field_4176_b = new NoiseGeneratorOctaves(moonRNG, 16);
    }
...
label1:
    ...
    public void func_4058_b(int i, int j, byte abyte0[])
    {
        ...
        for(int l = 0; l < 16; l++)
        {
            ...
            {
                boolean flag = field_4162_p[l + i1 * 16] + moonRNG.nextDouble() * 0.20000000000000001D > 0.0D;
                boolean flag1 = gravelNoise[l + i1 * 16] + moonRNG.nextDouble() * 0.20000000000000001D > 0.0D;
                int j1 = (int)(field_4160_r[l + i1 * 16] / 3D + 3D + moonRNG.nextDouble() * 0.25D);
                int k1 = -1;
                byte byte0 = (byte)Block.blockClay.blockID;
                byte byte1 = (byte)Block.blockClay.blockID;
                worldObj.getClass();
                for(int l1 = 127; l1 >= 0; l1--)
                {
                    ...
                    worldObj.getClass();
                    if(l1 >= 127 - moonRNG.nextInt(5))
                    {
                        abyte0[i2] = (byte)Block.bedrock.blockID;
                        continue;
                    }
                    if(l1 <= 0 + moonRNG.nextInt(5))
                    {
                        abyte0[i2] = (byte)Block.bedrock.blockID;
                        continue;
                    }
                    ...
                    if(byte2 != Block.blockClay.blockID)
                    {
                        continue;
                    }
                    if(k1 == -1)
                    {
                        ...
                        {
                            byte0 = 0;
                            byte1 = (byte)Block.blockClay.blockID;
                        } else
                        if(l1 >= k - 4 && l1 <= k + 1)
                        {
                            byte0 = (byte)Block.blockClay.blockID;
                            byte1 = (byte)Block.blockClay.blockID;
                            if(flag1)
                            {
    ...
    {
        moonRNG.setSeed((long)i * 0x4f9939f508L + (long)j * 0x1ef1565bd5L);
        worldObj.getClass();
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        {
            int k1 = k + moonRNG.nextInt(16) + 8;
            worldObj.getClass();
            int i3 = moonRNG.nextInt(128 - 8) + 4;
            int k4 = l + moonRNG.nextInt(16) + 8;
            (new WorldGenMoonWater(Block.waterMoving.blockID)).generate(worldObj, moonRNG, k1, i3, k4);
        }

        int j1 = moonRNG.nextInt(moonRNG.nextInt(10) + 1) + 1;
        for(int l1 = 0; l1 < j1; l1++)
        {
            int j3 = k + moonRNG.nextInt(16) + 8;
            worldObj.getClass();
            int l4 = moonRNG.nextInt(128 - 8) + 4;
            int i6 = l + moonRNG.nextInt(16) + 8;
            (new WorldGenFire()).generate(worldObj, moonRNG, j3, l4, i6);
        }

        j1 = moonRNG.nextInt(moonRNG.nextInt(10) + 1);
        for(int i2 = 0; i2 < j1; i2++)
        {
            int k3 = k + moonRNG.nextInt(16) + 8;
            worldObj.getClass();
            int i5 = moonRNG.nextInt(128 - 8) + 4;
            int j6 = l + moonRNG.nextInt(16) + 8;
            (new WorldGenGlowStone1()).generate(worldObj, moonRNG, k3, i5, j6);
        }

        for(int j2 = 0; j2 < 10; j2++)
        {
            int l3 = k + moonRNG.nextInt(16) + 8;
            worldObj.getClass();
            int j5 = moonRNG.nextInt(128);
            int k6 = l + moonRNG.nextInt(16) + 8;
            (new WorldGenGlowStone2()).generate(worldObj, moonRNG, l3, j5, k6);
        }

        if(moonRNG.nextInt(1) == 0)
        {
            int k2 = k + moonRNG.nextInt(16) + 8;
            worldObj.getClass();
            int i4 = moonRNG.nextInt(128);
            int k5 = l + moonRNG.nextInt(16) + 8;
            (new WorldGenFlowers(Block.mushroomBrown.blockID)).generate(worldObj, moonRNG, k2, i4, k5);
        }
        if(moonRNG.nextInt(1) == 0)
        {
            int l2 = k + moonRNG.nextInt(16) + 8;
            worldObj.getClass();
            int j4 = moonRNG.nextInt(128);
            int l5 = l + moonRNG.nextInt(16) + 8;
            (new WorldGenFlowers(Block.mushroomRed.blockID)).generate(worldObj, moonRNG, l2, j4, l5);
        }
